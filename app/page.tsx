...
function CommanderReveal({
  ...
  return (
    <motion.div
      className="flex flex-col items-center gap-5 w-full max-w-xs sm:max-w-sm mx-auto px-4"
      initial={{ opacity: 0, scale: 0.78, y: 56 }}
      animate={{ opacity: 1, scale: 1, y: 0 }}
      transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }}
    >
      {/* Card image + summoning glow + reveal flash */}
      <div className="relative w-full">
        {/* Flash overlay — fades out immediately after mount */}
        <div
        ...
        <motion.div
          ...
          animate={{
            boxShadow:
              "0 0 80px oklch(72% 0.115 82 / 0.35), 0 0 160px oklch(47% 0.24 292 / 0.18)",
          }}
      ...
      <motion.h2
        ...
        style={{
          ...
          textShadow: "0 0 32px oklch(72% 0.115 82 / 0.3)",
        }}
      ...
      {colorBadges.length > 0 && (
        ...
        >
          {colorBadges.map((c) => (
            <div
              key={c.key}
              className="relative w-7 h-7 rounded-full border-2 flex items-center justify-center text-xs font-semibold overflow-hidden"
              style={{
            ...
            >
              <div
                ...
                style={{
                  background: "radial-gradient(circle at 35% 28%, rgba(255,255,255,0.35) 0%, transparent 55%)",
                }}
              />
              <span
                className="relative z-10"
      ...
      {oracleText && (
        <motion.div
          className="w-full rounded-xl p-4 text-sm leading-relaxed whitespace-pre-line"
          style={{
